 ...
 * Game
 *
 * <p>Handles access to the games key attributes and some helpful functions
 *
 * @author James White
 */
...
public class Game {
   ...
   * updateTime
   *
   * <p>Update the time based on the current unix timestamp
   */
  ...
  /**
   * checkIfGameWon check against the winning patterns to see if the game has been won
   *
  ...
  public int checkIfGameWon() {
    ...
    for (String pattern : winningPatterns) {
      ...
      sum =
          gridValues[patternPart1 - 1]
              + gridValues[patternPart2 - 1]
